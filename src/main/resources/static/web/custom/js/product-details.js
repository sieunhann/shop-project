...
const renderProductImg = (obj) => {
    ...
    if(images.length > 1){
        for(let i = 1; i < images.length; i++){
            ...
            `
            sliderHtml += `
                <img data-hash="product-${i+1}" class="product__big__img" src="${images[i].url}" alt="">
            `
        }
    }
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg">
                            <img src="${el.imageEntities[0].url}" alt="">
                            <div class="label new">New</div>
                            <ul class="product__hover">
                                <li><a href="${el.imageEntities[0].url}" class="image-popup"><span class="arrow_expand"></span></a></li>
